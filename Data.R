...
lens_df <- tribble(
  ...
  # -- Lenses from the Houart Lab C1
  "Houart"          , "Nikon_C1"           , "Plan Fluor"        , "Nikon"       , NA                 ,  10            , 0.3                 , 16    , 0.17 , "M25X0.75"     , "air"          , NA    , NA                            ,
  "Houart"          , "Nikon_C1"           , "Fluor"             , "Nikon"       , NA                 ,  20            , 0.5                 ,  2    , 0    , "M25X0.75"     , "water"        , NA    , NA                            ,
  "Houart"          , "Nikon_C1"           , "Fluor"             , "Nikon"       , NA                 ,  40            , 0.8                 ,  2    , 0    , "M25X0.75"     , "water"        , NA    , NA                            ,
  "Houart"          , "Nikon_C1"           , "Plan Apo"          , "Nikon"       , NA                 ,  60            , 1.4                 ,  0.21 , 0.17 , "M25X0.75"     , "oil"          , NA    , NA                            ,
  "Houart"          , "Nikon_C1"           , "Plan Fluor"        , "Nikon"       , "MRL07920"         , 100            , 1.1                 ,  2.5  , 0    , "M25X0.75"     , "water"        , NA    , NA                            ,

  # -- Lenses from the Houart Lab fluorescence with Narishige microinjection
  "Houart"          , "Nikon_fluorescence" , "Plan Fluor"        , "Nikon"       , NA                 ,  10            , 0.3                 , 16    , 0.17 , "M25X0.75"     , "air"          , NA    , NA                            ,
  "Houart"          , "Nikon_fluorescence" , "LU Plan"           , "Nikon"       , NA                 ,  20            , 0.4                 , 13    , 0    , "M25X0.75"     , "air"          , NA    , NA                            ,
  "Houart"          , "Nikon_fluorescence" , "Fluor"             , "Nikon"       , NA                 ,  40            , 0.8                 ,  2    , 0    , "M25X0.75"     , "water"        , NA    , NA                            ,

  # -- Lenses from the Hindges Lab VAST BioImager Confocal
...
detector_df <- tribble(
  ...
  "Houart"    , "Nikon_C1"        , ""                , NA                    , "Nikon Corporation"  , "PMT"   ,

  "Hindges"   , "VAST_BioImager"  , "Retiga R6 Top"   , "01-RET-R6-M-14-C-OC" , "QImaging"           , "CCD"   ,
  "Hindges"   , "VAST_BioImager"  , "Retiga R6 Back"  , "01-RET-R6-M-14-C-OC" , "QImaging"           , "CCD"   ,
  "Hindges"   , "VAST_BioImager"  , "Prosilica GX"    , ""                    , "Allied Vision"      , "CCD"   ,
)
...
camera_df <- tribble(
  ...
  "Hindges"                   , "VAST_BioImager"            , "Retiga R6 Top"     ,         1392 ,           1040 , 6.45          , 6.45          , "micrometers"    , NA                  , 14 , NA  ,  10   , NA    , NA    , NA       , NA   , NA        , NA , NA , 0.6  , FALSE , NA ,
  "Hindges"                   , "VAST_BioImager"            , "Retiga R6 Back"    ,         1392 ,           1040 , 6.45          , 6.45          , "micrometers"    , NA                  , 14 , NA  ,  10   , NA    , NA    , NA       , NA   , NA        , NA , NA , 0.6  , FALSE , NA ,
  "Hindges"                   , "VAST_BioImager"            , "Prosilica GX"      , NA           , NA             , NA            , NA            , "micrometers"    , NA                  , NA , NA  , NA    , NA    , NA    , NA       , NA   , NA        , NA , NA , NA   , FALSE , NA ,
...
pmt_df <- tribble(
  ...
  "Houart"    , "Nikon_C1"      , ""         , "uknown"  , NA               , NA             , NA                  , NA         , NA                       , NA                   , FALSE        , NA                  , NA                       ,
)
...
save(
  ...
  camera_df,
  column_help,
  file = "microscope_data.RData"
)
message(
  "Saved microscope_data.RData with system_df, lens_df, detector_df, camera_df, pmt_df and column_help."
)
